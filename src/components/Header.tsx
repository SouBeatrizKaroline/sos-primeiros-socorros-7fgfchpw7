      ...
      <div className="container mx-auto max-w-6xl px-4 py-2.5 flex items-center justify-between gap-2">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-lg sm:text-xl tracking-tight text-foreground">
                SOS <span className="text-red-600">Primeiros Socorros</span>
              </span>
            </div>
            <p className="hidden md:block text-xs text-muted-foreground font-medium">
              Não substitui atendimento médico ou serviços de emergência.
            </p>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size="default"
            className={`font-bold gap-2 px-4 shadow-md transition-all duration-300 ${
              emergencyMode
